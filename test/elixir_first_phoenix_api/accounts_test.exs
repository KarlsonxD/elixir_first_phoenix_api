defmodule ElixirFirstPhoenixApi.AccountsTest do
  use ElixirFirstPhoenixApi.DataCase

  alias ElixirFirstPhoenixApi.Accounts

  describe "accounts" do
    alias ElixirFirstPhoenixApi.Accounts.Account

    import ElixirFirstPhoenixApi.AccountsFixtures
