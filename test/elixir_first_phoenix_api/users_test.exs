defmodule ElixirFirstPhoenixApi.UsersTest do
  use ElixirFirstPhoenixApi.DataCase

  alias ElixirFirstPhoenixApi.Users

  describe "users" do
    alias ElixirFirstPhoenixApi.Users.User

    import ElixirFirstPhoenixApi.UsersFixtures
